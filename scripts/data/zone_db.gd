...
static var _ZONES: Dictionary = {
	"vela": {
		...
		"exits": {
			...
			"0,5": {"zone_id": "vela_outskirts", "spawn": [13, 11]}
		},
		"encounters": []
	},
	"vela_outskirts": {
		"name": "Obrzeża Veli",
		"biome": "łąki / gospodarstwa",
		"recommended_level": 2,
		"spawn": [13, 11],
		"map_rows": [
			"TTTTTTTTTTTTTTT",
	...
	"resonance_route": {
		...
		"exits": {
			...
			"7,0": {"zone_id": "whispering_grove", "spawn": [7, 21]},
			"0,10": {"zone_id": "echo_cave", "spawn": [13, 10]},
			"14,10": {"zone_id": "tideglass_coast", "spawn": [1, 10]}
		},
		"encounters": [
	...
	"whispering_grove": {
		...
		"exits": {
			"7,22": {"zone_id": "resonance_route", "spawn": [7, 1]},
			"7,0": {"zone_id": "north_gate", "spawn": [7, 21]}
		},
		"encounters": [
			{"name": "Wahlik", "weight": 100, "min_level": 4, "max_level": 7}
		]
	},
	"tideglass_coast": {
		"name": "Szkliste Wybrzeże",
		"biome": "piasek / płytkie morze",
		"recommended_level": 5,
		"spawn": [1, 10],
		"map_rows": [
			"TTTTTTTTTTTTTTT",
		...
		"exits": {
			"0,10": {"zone_id": "resonance_route", "spawn": [13, 10]}
		},
		"encounters": [
			{"name": "Wahlik", "weight": 100, "min_level": 4, "max_level": 7}
		]
	...
	"echo_cave": {
		"name": "Jaskinia Echa",
		"biome": "jaskinia / rezonujące kryształy",
		"recommended_level": 6,
		"spawn": [13, 10],
		"map_rows": [
			"KKKKKKKKKKKKKKK",
		...
		"exits": {
			"14,10": {"zone_id": "resonance_route", "spawn": [1, 10]}
		},
		"encounters": [
			{"name": "Wahlik", "weight": 100, "min_level": 5, "max_level": 8}
		]
	},
	"north_gate": {
		"name": "Północna Brama",
		"biome": "fort / arena próby",
		"recommended_level": 7,
		"spawn": [7, 21],
		"map_rows": [
			"TTTTTTTTTTTTTTT",
		...
		"exits": {
			"7,22": {"zone_id": "whispering_grove", "spawn": [7, 1]}
		},
		"encounters": []
	}
}
