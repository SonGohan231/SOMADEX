...
static func frame_texture(creature_name: String, action: String, frame: int) -> Texture2D:
	...
	for family in [REVERSE15,REVERSE10,REVERSE09,REVERSE08,REVERSE07,REVERSE06,REVERSE05,REVERSE04]:
...
static func source_kind(creature_name: String) -> String:
	...
	for family in [REVERSE15,REVERSE10,REVERSE09,REVERSE08,REVERSE07,REVERSE06,REVERSE05,REVERSE04]:
		if family.has_animation(creature_name): return "sprite-strip-authored-runtime"
