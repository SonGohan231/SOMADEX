...
func _initialize() -> void:
	...
	if errors.is_empty():
		print("CREATURE_SPRITE_RUNTIME_SMOKE: PASS · 150 forms · 130 approved seeds · 650 accepted logical animations · 20 QA fallbacks · authored families006-010+015 preserved")
		quit(0)
		return
