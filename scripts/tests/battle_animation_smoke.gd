...
func _test_sprite_catalog(errors: Array[String]) -> void:
	...
	var reverse_families: Array[String] = ["Srubik", "Torsys", "Spiralion", "Uczek", "Obiegnik", "Labiryntaur", "Kotwiczek", "Bramnik", "Fundamentor", "Nasuch", "Echouszek", "Sensoryks", "Nucik", "Wibrospiew", "Rezonar"]
	...
	for name: String in ["Luzik", "Synkronaut", "Bocznik", "Falomamut", "Wahlik", "Kartografon", "Srubik", "Torsys", "Spiralion", "Uczek", "Obiegnik", "Labiryntaur", "Kotwiczek", "Bramnik", "Fundamentor", "Nasuch", "Echouszek", "Sensoryks", "Nucik", "Wibrospiew", "Rezonar"]:
