...
func _test_sprite_catalog(errors: Array[String]) -> void:
	...
	var reverse_families: Array[String] = ["Kompasik", "Oktantor", "Kartografon", "Srubik", "Torsys", "Spiralion", "Uczek", "Obiegnik", "Labiryntaur", "Kotwiczek", "Bramnik", "Fundamentor", "Nasuch", "Echouszek", "Sensoryks", "Nucik", "Wibrospiew", "Rezonar"]
	...
	for name: String in ["Luzik", "Synkronaut", "Bocznik", "Falomamut", "Wahlik", "Kompasik", "Oktantor", "Kartografon", "Srubik", "Torsys", "Spiralion", "Uczek", "Obiegnik", "Labiryntaur", "Kotwiczek", "Bramnik", "Fundamentor", "Nasuch", "Echouszek", "Sensoryks", "Nucik", "Wibrospiew", "Rezonar"]:
