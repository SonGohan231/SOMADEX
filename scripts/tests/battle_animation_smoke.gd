...
func _test_sprite_catalog(errors: Array[String]) -> void:
	...
	var reverse_families: Array[String] = ["Pufek", "Pulsopuch", "Falomamut", "Wahlik", "Oscylot", "Fazoryb", "Kompasik", "Oktantor", "Kartografon", "Srubik", "Torsys", "Spiralion", "Uczek", "Obiegnik", "Labiryntaur", "Kotwiczek", "Bramnik", "Fundamentor", "Nasuch", "Echouszek", "Sensoryks", "Nucik", "Wibrospiew", "Rezonar"]
	...
	for name: String in ["Luzik", "Synkronaut", "Bocznik", "Pufek", "Pulsopuch", "Falomamut", "Wahlik", "Oscylot", "Fazoryb", "Kompasik", "Oktantor", "Kartografon", "Srubik", "Torsys", "Spiralion", "Uczek", "Obiegnik", "Labiryntaur", "Kotwiczek", "Bramnik", "Fundamentor", "Nasuch", "Echouszek", "Sensoryks", "Nucik", "Wibrospiew", "Rezonar"]:
...
func _test_visual_states(errors: Array[String]) -> void:
	for action: String in SPRITES.ACTIONS:
		...
		for frame: int in range(count):
			...
			var final_load: Texture2D = SPRITES.frame_texture("Falomamut", action, frame)
			_expect(final_load != null, "Falomamut %s authored frame %d failed" % [action, frame], errors)
